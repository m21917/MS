$(document).ready(function(){
	...
	var table = $('#unitListTable').dataTable( {
        "ajax": "AjaxCompetitionUnitList.php",
        "info": true,
        "order": [],
        "columnDefs": [ {
      		"targets": [ 0 ],
	...
	$(".insertUnit").click(function(){
		...
		$.ajax({
					...
					type: "POST",
					data: {insertLoadUnit: true, id: id},
					success: function(data) {
						console.log(data);
						target.addClass('list-group-item-success').removeClass('insertUnit');
	...
	function initAddUnitForm(){
		...
		$("#unitName_empty,#mainField_ErrorMsg,#subField_ErrorMsg,#grade_ErrorMsg,#KeyWord_empty").hide();
		$("#unitId").val("");
		$("#unitName").val("");
	...
	$('#mainField,#subField').on('blur', function(){
		var show = $(this).attr('id');
		checkSelect(show);
	});

	$('#mainField,#subField').on('change', function(){
		var show = $(this).attr('id');
		checkSelect(show);
	});
	...
	$('#changeStatusModal').on('hidden.bs.modal', function (e) {  //當更變更主題狀態視窗結束時...
  		// do something...
  		initAddUnitForm();
	});
	...
	$(document).on('click', '.editExample', function(){
		...
		$.ajax({
					url: "AjaxCompetition.php",
					type: "POST",
					data: {loadUnitInfo: true, unit_id: unit_id,type:1},
					success: function(data) {
						console.log(data);
						var jsonData = $.parseJSON(data);
	...
	$(document).on('click', '.editGuidance', function(){
		...
		$.ajax({
					url: "AjaxCompetition.php",
					type: "POST",
					data: {getGuidance: true, id: unit_id},
					success: function(data) {
						console.log(data);
						var jsonData = $.parseJSON(data);
	...
	function updateGuidance(){
		...
		if (uid && content){
			$.ajax({
					url: "AjaxCompetition.php",
					type: "POST",
					data: {newGuidance: true, cmsunit_id: uid,gid:gid,guidance:content},
					success: function(data) {
						console.log(data);
						var jsonData = $.parseJSON(data);
	...
	$("#addUnit_Submit").on("click",function(){
		var id = $('#unitId').val();
		...
		if (unit && unit_length && field1 && field2 && grade && checkNum >= 3) {
			$.ajax({
				url: "AjaxCompetition.php",
				type: "POST",
				data: {newUnit:true, id:id, unit:unit, field1:field1, field2:field2, grade:grade,keyWord:keyWord},
				success: function(data) {
					console.log(data);
					var jsonData = $.parseJSON(data);
					if (jsonData) {
		...
		switch(action) {
			case 'edit':
				$.ajax({
					url: "AjaxCompetition.php",
					type: "POST",
					data: {loadUnitInfo: true, unit_id: unit_id,type:0},
					success: function(data) {
						console.log(data);
						var jsonData = $.parseJSON(data);
						$("#unitId").val(jsonData[0].id);
			...
			case 'changeStage':
				...
				$.ajax({
							url: "AjaxCompetition.php",
							type: "POST",
							data: {getUnitStatus: true, unit_id: unit_id},
							success: function(data) {
								console.log(data);
								var jsonData = $.parseJSON(data);
								if(jsonData == 0){
			...
			case 'delete':
				$.ajax({
							url: "AjaxCompetition.php",
							type: "POST",
							data: {getDeleteType: true, unit_id: unit_id},
							success: function(data) {
								console.log(data);
	...
	$("#deleteUnitSubmit").on("click",function(){
		...
		$.ajax({
					url: "AjaxCompetition.php",
					type: "POST",
					data: {deleteUnit: true, unit_id: unit_id},
					success: function(data) {
		...
		if(deleteType == 0){	//若該主題已投稿至儲文所,取消投稿
			$.ajax({
				url: "AjaxCompetition.php",
				type: "POST",
				data: {cancelSendArticle:true, id:unit_id},
				success: function(data) {
					var jsonData = $.parseJSON(data);
	...
	function changeStatus(){
		...
		$.ajax({
					url: "AjaxCompetition.php",
					type: "POST",
					data: {changeUintStatus: true, id: unit_id,status:status},
					success: function(data) {
						table.ajax.reload();
	...
	function tabSaveVerify() {
		...
		if (id && clickTab && article && content && fromOption && from) {
			$.ajax({
				url: "AjaxCompetition.php",
				type: "POST",
				data: {newExample:true, id:id, exampleNums:clickTab, article:article, content:content, fromOption:fromOption, from:from},
				success: function(data) {
					var jsonData = $.parseJSON(data);
					if (jsonData) {
	...
	function checkExampleStatus(unit) {
		...
		$.ajax({
			url: "AjaxCompetition.php",
			type: "POST",
			data: {checkExampleStatus:true, id:unit},
			success: function(data) {
				var jsonData = $.parseJSON(data);
	...
	function LoadArticleExample(unit, tab) {  //取得範文內容
		...
		$.ajax({
			url: "AjaxCompetition.php",
			type: "POST",
			data: {checkExample:true, id:unit, exampleNums:tab},
			success: function(data) {
				var jsonData = $.parseJSON(data);
	...
	$(document).on('click', '.sendArticle', function(){
		...
		$.ajax({
				url: "AjaxCompetition.php",
				type: "POST",
				data: {sendArticle:true, id:unit_id},
				success: function(data) {
					var jsonData = $.parseJSON(data);
					console.log("log="+jsonData);
					if (jsonData) {
