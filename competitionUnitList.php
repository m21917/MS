...
?>
	...
	<script type="text/javascript" src="js/competitionUnitList_js.js"></script>
<?php
...
<?php
	...
	if($dbObject->personRegistCheck($account)){	//如果有報名個人賽
?>
	<div class="row" style="margin-top:20px;">
